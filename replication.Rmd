...
z <- plot(DD_diff) +
  ...
  scale_y_discrete(labels = y_labs2) +
    geom_point(size=1.75) +
    geom_point(data = grey_amce, size = 1.75) +
    geom_errorbarh(data=grey_amce, aes(xmin = lower, xmax = upper), color = 'grey', height = 0) +
  geom_vline(xintercept = 0, linetype="dotted", color = "red")
```
...
mm_1 + mm_2 + plot_layout(widths = c(1, 1))
```
